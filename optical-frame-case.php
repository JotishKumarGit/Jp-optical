...
<body class="index-page">
    ...
    <section class="shadow-lg" style="background-color: rgb(165 183 168);">
        <div class="container">
            <div class="py-5">
                <h2 class="text-center">Optical Frame Case</h2>
            </div>
            <div class="row shadow-lg align-items-center py-5 px-4 "
                ...
                <div class="col-12 col-md-6 col-lg-6 col-sm-12 mb-5" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p class="lh-lg" data-aos="fade-up" data-aos-delay="200">Protect your eyewear in style with our Optical Frame Case, designed for both functionality and elegance. Crafted from high-quality materials, this case provides the ultimate safeguard for your optical frames, ensuring they remain scratch-free and secure while you're on the go.</p>
                    <ul>
                        <li class="lh-lg" data-aos="fade-up" data-aos-delay="200"><b>Durable Construction :</b>   Made from premium materials that withstand daily wear and tear, keeping your frames safe and secure.</li>
                        <li class="lh-lg" data-aos="fade-up" data-aos-delay="200"><b>Sleek and Stylish Design :</b>    Available in a variety of colors and patterns, our case complements any style while providing a sophisticated touch.</li>
                    </ul>
