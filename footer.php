    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-12  my-2">
            <input type="number" class="form-control number" value="" placeholder="Enter Your Quantity" required>
          </div>
          <div class="col-12 my-2">
            <input type="text" class="form-control product" value="" placeholder="Write Your Interested Product" required>
          </div>
