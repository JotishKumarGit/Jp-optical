...
<body class="index-page">
    ...
    <div class="bg slider">
        <h2 class="text">Mobile Cleaning Gel</h2>
    </div>
    ...
    <section class="shadow-lg" style="background-color: rgb(165 183 168);">
        <div class="container">
            <div class="py-5">
                <h2 class="text-center">Mobile Cleaning Gel</h2>
            </div>
            <div class="row shadow-lg align-items-center py-5 px-4 "
                ...
                <div class="col-12 col-md-6 col-lg-6 col-sm-12 mb-5" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p class="lh-lg" data-aos="fade-up" data-aos-delay="200">Experience the ultimate solution for on-the-go cleaning with our Mobile Cleaning Gel. Specially formulated to effectively remove dirt, smudges, and fingerprints from your electronic devices, this gel is perfect for smartphones, tablets, laptops, and more. Its gentle, non-abrasive formula ensures that your screens remain scratch-free and pristine.</p>
                    <ul>
                        <li class="lh-lg" data-aos="fade-up" data-aos-delay="200"><b>Effective Cleaning :</b> Easily removes dust, grease, and fingerprints without leaving streaks.</li>
                        <li class="lh-lg" data-aos="fade-up" data-aos-delay="200"><b>Compact and Portable :</b> Designed for convenience, this gel fits perfectly in your bag or pocket, making it ideal for travel.</li>
                    </ul>
                ...
                <div class="col-12 col-md-6 col-lg-6 col-sm-12" data-aos="fade-up" data-aos-delay="200">
                    <div class="image-effect">
                        <div class="img-a ">
                            <img src="./assets/img/products/mobile-cleaning-gel.jpg" alt="" class="shadow-lg " height="auto" width="100%"
