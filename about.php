        ...
        <div class="container">
            ...
            <div class="row shadow-lg align-items-center py-5 px-4 align-items-center"
                ...
                <div class="col-12 col-md-6 col-lg-6 col-sm-12" data-aos="fade-up" data-aos-delay="200">
                    <div class="image-effect">
                        <div class="img-a ">
                            <img src="./assets/img/products/mission.webp" alt="" class="shadow-lg " height="auto" width="100%"
                                style="object-fit: cover; border: 1px dashed greenyellow; border-radius: 20px;" data-aos="fade-up"
                                data-aos-delay="200">
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row shadow-lg align-items-center py-5 px-4 "
                ...
                <div class="col-12 col-md-6 col-lg-6 col-sm-12" data-aos="fade-up" data-aos-delay="200">
                    <div class="image-effect">
                        <div class="img-a ">
                            <img src="./assets/img/products/vission.jpg" alt="" class="shadow-lg " height="auto" width="100%"
                                style="object-fit: cover; border: 1px dashed greenyellow; border-radius: 20px;" data-aos="fade-up"
                                data-aos-delay="200">
                        </div>
                    </div>
