...
<body class="index-page">
    ...
    <div class="bg slider">
        <h2 class="text">Optical Lens Cleaning Gel</h2>
    </div>
    ...
    <section class="shadow-lg" style="background-color: rgb(165 183 168);">
        <div class="container">
            <div class="py-5">
                <h2 class="text-center">Optical Lens Cleaning Gel</h2>
            </div>
            <div class="row shadow-lg align-items-center py-5 px-4 "
                ...
                <div class="col-12 col-md-6 col-lg-6 col-sm-12 mb-5" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p class="lh-lg" data-aos="fade-up" data-aos-delay="200">Ensure crystal-clear vision with our Optical Lens Cleaning Gel, expertly designed to keep your eyewear and optical devices spotless. Whether you wear glasses, sunglasses, or use high-end cameras and binoculars, our gel provides a gentle yet effective cleaning solution that enhances clarity and performance.</p>
                    <ul>
                        <li class="lh-lg" data-aos="fade-up" data-aos-delay="200"><b> Specialized Formula :</b>  Specifically formulated to safely clean all types of optical lenses, including anti-reflective coatings.</li>
                        <li class="lh-lg" data-aos="fade-up" data-aos-delay="200"><b>Streak-Free Formula :</b>  Enjoy a flawless shine with our non-abrasive gel that leaves no streaks or residue behind.</li>
                    </ul>
                ...
                <div class="col-12 col-md-6 col-lg-6 col-sm-12" data-aos="fade-up" data-aos-delay="200">
                    <div class="image-effect">
                        <div class="img-a ">
                            <img src="./assets/img/products/optical-l ense-cleaning-liquid.avif" alt="" class="shadow-lg " height="auto" width="100%"
